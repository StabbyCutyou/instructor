...
func BenchmarkInputToArgs16Inputs(b *testing.B) {
	i := New()
	input := []string{"true bool", "100 int", "hey string", "500.0 *float64", "true bool", "100 int", "hey string", "500.0 float64", "true bool", "100 int", "hey string", "500.0 *float64", "true bool", "100 int", "hey string", "500.0 float64"}
	for j := 0; j < b.N; j++ {
		i.inputToArgs(input)
	}
}
